...
object MainObject {
  def main(args: Array[String]): Unit = {
    ...
    breakable {
      while (true) {
        println("\nPress")
        println("To insert an element enter 1")
        println(" To insert square of an element enter 2")
        println(" To delete an element enter 3")
        println("To Display the Queue enter 4")
